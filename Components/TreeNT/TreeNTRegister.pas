...
uses DsgnIntf, TreeNT, TNTEditor, Dialogs, Forms, SysUtils;

type TTreeNTNodesProperty = class(TClassProperty)
     public
...
var Verbs : array[0..VerbCount-1] of String = ('Edit tree nodes ...',
                                               'Load from file ...',
                                               'Save to tree file ...',
                                               'Save to text file ...',
                                               'Save to bitmap file ...',
...
begin
  case Index of
    0 : if EditTreeViewItems(TTreeNT(Component).Items) then Designer.Modified;
    1 : begin
...
begin
  RegisterComponents('Additional',[TTreeNT]);
